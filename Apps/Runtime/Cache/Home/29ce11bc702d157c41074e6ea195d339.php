...
<html style="font-size: 40px;">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/ssyp/Public/Home/css/brandList.css">
		...
		<div class="container">
			<div class="recommand">
				<ul class="cont">
					...
					<li>
						<img src="/ssyp/Public/Home/images/store2.jpg" alt="">
						<span class="name">太极拳服</span>
					</li>
					<li>
						<img src="/ssyp/Public/Home/images/store3.jpg" alt="">
						<span class="name">太极拳服</span>
					</li>
					<li>
						<img src="/ssyp/Public/Home/images/store4.jpg" alt="">
						<span class="name">太极拳服</span>
					</li>
				</ul>
			</div>
