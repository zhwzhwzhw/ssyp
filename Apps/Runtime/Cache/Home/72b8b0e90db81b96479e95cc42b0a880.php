...
<html style="font-size: 40px;">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/ssyp/Public/Home/css/task.css">
				...
				<li>
					...
					<div class="li_center">
						<div class="li_top_center">
							<span class="name active">商品名称</span>
					...
					<div class="li_bottom">
						<button class="li_bottom_right active2">点击打卡</button>
					</div>
				</li>
				<li>
					<div class="li_left">
