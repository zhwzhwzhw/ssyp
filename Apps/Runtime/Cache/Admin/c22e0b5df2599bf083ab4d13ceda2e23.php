...
<script>
$(function(){
	$('.category-index,.category').addClass('active');
})
</script>
...
<table id="detail" class="list">
	...
	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
			...
			<td><?php echo str_repeat('|-',$vo['s']-1); echo ($vo["c_name"]); ?></td>
 			<td>
				<?php if($vo["c_icons"] != ''): ?><img src="/ssyp/Uploads/<?php echo ($vo["c_icons"]); ?>" width="50px"><?php endif; ?>
			</td> 
			<td><?php echo ($vo["c_ordernum"]); ?></td>
			<td>
				<a href="/ssyp/index.php/Admin/Category/update/id/<?php echo ($vo["id"]); ?>">编辑</a><br/>
			</td>
