...
<meta charset="utf-8">
<title>权限列表</title>
<script type ="application/javascript" src="/ssyp/Public/Statics/js/jquery.js"></script>
...
<table id="detail">
	...
	<?php if(is_array($power)): foreach($power as $key=>$v): ?><tr>
			<td><?php echo ($v["id"]); ?></td>
			...
			<td>
				<a href="/ssyp/index.php/Admin/Power/update/id/<?php echo ($v["id"]); ?>">修改</a>
				<a href="/ssyp/index.php/Admin/Power/del/id/<?php echo ($v["id"]); ?>">删除</a>
			</td>
