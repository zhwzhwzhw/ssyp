...
<form method="post" action="">
	<table id="detail" class="list">
		<tr>
			...
			<th>地址</th>
			<th>导航位置</th>
			<th style="width:200px">允许权限(无表示所有)</th>
			<th>操作</th>
		</tr>
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
				<td><?php echo ($v["id"]); ?></td>
				<td><?php echo ($v["seller_name"]); ?></td>
				<!-- <td><?php echo ($v["unit_id"]); ?></td> -->
				<td><?php echo ($v["seller_phone"]); ?></td>
				<td><?php echo ($v["seller_address"]); ?></td>
				<td><?php echo ($v["seller_position"]); ?></td>
				<td><?php echo (return_cat_list($v["cat_list"])); ?></td>
				<td><a href="/ssyp/index.php/Admin/Admin/shop?del=del&id=<?php echo ($v["id"]); ?>">删除</a>&nbsp;&nbsp;&nbsp;
					<a href="/ssyp/index.php/Admin/Admin/shop_add?id=<?php echo ($v["id"]); ?>">编辑</a>
				</td>
