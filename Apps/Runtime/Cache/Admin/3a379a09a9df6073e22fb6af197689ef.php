...
<form method="post" action="/ssyp/index.php/Admin/News/save">
<table id="detail">
	<tr>
	...
	<tr>
		...
		<td>
			...
			<img id="image_show" src="/ssyp/Uploads/<?php echo ($data["image"]); ?>" <?php if($data["id"] == ''): ?>style="display:none"<?php endif; ?> width="200px" alt="">
...
<!--  	<tr>
		<td colspan="2">
			 <script id="editor" type="text/plain" name="content" ><?php echo ($data["content"]); ?></script>			
		</td>
	</tr>-->
	<tr>
...
$(function(){
	h_upload('image_button','/ssyp/index.php/Admin/Upload/Upload','callback_image');
})
var oldImgName = '<?php echo ($data["image"]); ?>';
function callback_image(imgdata){
	if(oldImgName != ''){
		$.ajax({
			'url':'/ssyp/index.php/Admin/Upload/image',
			'type':'post',
