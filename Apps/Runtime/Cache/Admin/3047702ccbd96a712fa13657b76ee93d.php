...
<form method="post" action="/ssyp/index.php/Admin/User/saveinfo">
           ...
           <div class="container_form" >
            ...
            <!--表单-->
                <div class="form-group">
                    ...
                    <input  type="text" name="title" value="<?php echo ($data["title"]); ?>" style="width: 175px;padding:3px">
                </div>
               <div class="form-group">
                   <label class="form-title">内容：</label>
                   <textarea  rows="4px" cols="50px" name="content" value="<?php echo ($data["content"]); ?>" style="padding:3px"></textarea>
               </div>
