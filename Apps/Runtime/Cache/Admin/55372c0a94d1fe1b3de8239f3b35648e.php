...
<html>
	...
	<div class="container">
		...
		<div style="margin-top: 0" class="detail">
			<span onclick="shenhe()" class="btn btn-large btn-update">添加分组</span>
		</div>
		<div class="table-main">
			<table class="table">
				...
				<?php if(is_array($group)): foreach($group as $key=>$v): ?><tr>
						...
						<td>
							<a href="/ssyp/index.php/Admin/User/info?id=<?php echo ($v["id"]); ?>" class="btn btn-large  btn-update">站内信息</a>
							<a href="/ssyp/index.php/Admin/User/groupuser?id=<?php echo ($v["id"]); ?>" class="btn btn-large  btn-update">查看组员</a>
							<a onclick="editor(this)" data-id="<?php echo ($v["id"]); ?>" data-name="<?php echo ($v["name"]); ?>" class="btn btn-large  btn-update">编辑</a>
